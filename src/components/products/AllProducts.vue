<template>
  <div>
    ...
    <!-- Filters Button -->
    <button class="button1"><i class="fa fa-filter"></i> Filters</button>
...
.product-card {
  width: calc(50% - 25px); /* Adjust the width as needed */
  text-align: left;
}
.product-image {
  max-width: 253px;
...
.old-price {
  ...
  font-size: 14px;
  color: rgba(101, 101, 101, 1); /* Customize the old price color */
}
.new-price {
  font-size: 14px;
  margin-left: 10px;
...
export default {
  metaInfo() {
    return {
      title: "All Products | M|FITAmazing", // Customize the title
      meta: [
        {
          name: "description",
          content:
            "Explore our wide range of high-quality activewear products. Find the perfect workout gear to boost your confidence and style.",
        },
        {
          property: "og:image",
          content: "@/assets/1.jpg",
        },
      ],
    };
  },
